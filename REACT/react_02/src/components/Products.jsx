...
// const Products = (props) => { --Esta línea se comento porque fue referente a prop estructurados
    ...
    */}
{/*Pros estructurados. Puedo asignar diferentes propiedades a un div, sin tener que generar muchos props, solamente usando la palabra reservada 'props' como parámetro de la función
...
{/* <div className='cards'>
 ...
 {/* Props desestructurados. Permite asignar datos de un objeto a una variable separada para que dicha variables puede contener los datos provenientes del objeto.
