 ...
 * Permite que los métodos tomen diferente formas al ser heredadas, usando una pantilla base.
 * *** interface
 * Es un tipo de "clase" que define un conjunto de métodos que pueden ser implementados por diversas clases.
 */
