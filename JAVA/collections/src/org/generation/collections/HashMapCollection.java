...
public class HashMapCollection {
	public static void main (String[] args) {
		/*
		 * HasMap Almacena elementos en apres "clave/valor" y se puede acceder a ellos mediante index.
		 * No es  ordenado y permite datos duplicados
		 */
		HashMap<String, String> capitals = new HashMap<String, String>(); // <clave, valor>  la clave puede ir cambiando
		...
		for (Map.Entry<String, String> entry : capitals.entrySet()) {
			//Mostrar la clave (.getKey()) y el valor (.getValue()) de manera individual para su manipulaci÷on
